...
item2.EMAIL;type=INTERNET:akariibotz@gmail.com\n
...
"message": {
"pollCreationMessage": {
"name": `ManzX Bot ${virus}${virtex(prefix)}`,
"options": [
	{
...
kayla.sendMessage(m.chat,{text:`Mau Script Bot Nya? Silahkan Chat Aja Broo@${creator.split("@")[0]}`,mentions: [creator], },{quoted:m})
}
break
case 'q': case 'quoted': {
...
owned = '6281215845044@s.whatsapp.net'
ngen = `
Title : ${anu.title}
Ext : Search
ID : ${anu.videoId}
...
"mediaType": 1, 
"thumbnail": eek,
"mediaUrl": 'https://chat.whatsapp.com/FKEPizxKw6cDM1aeVoaqWv',
"sourceUrl": 'https://chat.whatsapp.com/FKEPizxKw6cDM1aeVoaqWv'
}}
}
...
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 8K • Sewabot 1 Bulan
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '1tahun'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 11K • Sewabot 1 Tahun
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == 'permanent'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 15K • Sewabot Permanent
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
}
break
case 'premkay':
...
case 'addprem':
if (!itsMeKayla) return reply(mess.owner)
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281215845044`)
